...
namespace MangersWebApi.Helpers
{
    ...
    {
        public static string AddFile(this IWebHostEnvironment environment, IFormFile file, string _path)
        {
            ...
            if (file != null && existingFile == null)
            {
                ...
                return "https://localhost:44341" + path;
            }
            else
            {
                return "https://localhost:44341" + _path + existingFile.Name;
            }
        }
        ...
        private static Dictionary<string, IFileInfo> GetAllFilesMd5Hash(this IWebHostEnvironment environment,
            string path)
        {
